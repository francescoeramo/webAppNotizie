// Generato automaticamente il 2026-07-21 07:36 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784619357;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "The US says the attacks were aimed at degrading Iran's capabilities to attack ships in the Strait of Hormuz.",
    source: "BBC World",
  ...
  },
  {
    id: 6,
    cat: "geopolitica",
    title: "Trump aprueba nuevos aranceles del 50% para Canadá en plenas negociaciones por el TMEC",
    summary: "El presidente alega un trato discriminatorio a algunos productos estadounidenses. Pagarán el gravamen materiales de automoción, productos lácteos y bebidas alcohólicas",
    body: "El presidente de Estados Unidos, Donald Trump, ha aprobado este lunes una nueva batería de aranceles del 50% para determinados productos canadienses alegando “un trato discriminatorio de Canadá hacia los productos estadounidenses” el mismo día que comienza la segunda ronda de revisión del tratado comercial entre Estados Unidos, Canadá y México (T-MEC). A través de tres órdenes ejecutivas, el mandatario republicano ha establecido nuevos gravámenes a la importación del 50% sobre materiales de vehículos a motor, productos lácteos y bebidas alcohólicas .\n\n“Al hacerlo, el presidente compensa la carga y la desventaja que supone para el comercio estadounidense el trato discriminatorio de Canadá y crea igualdad de condiciones para exportaciones estadounidenses cruciales: automóviles, alcohol y productos lácteos”, señala la Casa Blanca. Seguir leyendo",
    source: "El Pais",
    url: "https://elpais.com/internacional/2026-07-20/trump-aprueba-nuevos-aranceles-del-50-para-canada-en-plenas-negociaciones-por-el-tmec.html",
    time: "8 ore fa",
    pub_ts: 1784588294,
    tags: [],
  },
  ...
  },
  {
    ...
    body: "30 days into the US-Iran MoU the worst fighting in months has erupted threatening to unravel the ceasefire.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "US Central Command (CENTCOM) released footage of its forces launching the latest round of strikes against Iran.",
    body: "US Central Command (CENTCOM) released footage of its forces launching the latest round of strikes against Iran.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/video/newsfeed/2026/7/21/aje-onl-nf_us-military-releases-footage-of-strikes-on-iran-200726?traffic_source=rss",
    time: "4 ore fa",
    pub_ts: 1784603723,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "Jijia Vision is in discussions to hold an initial public offering on Hong Kong’s stock exchange as soon as this year, joining a flurry of Chinese AI firms planning public market debuts.",
    body: "Jijia Vision is in discussions to hold an initial public offering on Hong Kong’s stock exchange as soon as this year, joining a flurry of Chinese AI firms planning public market debuts.",
    source: "Bloomberg Tech",
    url: "https://www.bloomberg.com/news/articles/2026-07-21/china-s-gigaai-seeks-2026-hong-kong-ipo-in-first-for-world-model",
    time: "6 ore fa",
    pub_ts: 1784596484,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "For Larry Fink, BlackRock Inc.’s more than $12 billion debt sale for a Meta Platforms Inc. data center is the result of years spent transforming a public investments giant into a heavy hitter in private markets too.",
    body: "For Larry Fink, BlackRock Inc.’s more than $12 billion debt sale for a Meta Platforms Inc. data center is the result of years spent transforming a public investments giant into a heavy hitter in private markets too.",
    source: "Bloomberg Tech",
