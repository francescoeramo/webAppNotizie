// Generato automaticamente il 2026-07-16 23:03 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784242964;
...
const NEWS = [
  ...
  },
  {
    ...
    summary: "The US says its attacks aim to \"further degrade Iranian military capabilities\", as fighting continued for the sixth day in a row.",
    body: "The US says its attacks aim to \"further degrade Iranian military capabilities\", as fighting continued for the sixth day in a row.",
    source: "BBC World",
  ...
  },
  {
    ...
    summary: "Iran accuses US of 'cowardly war crime' as doctor says blast was 'so close' they thought the hospital was struck.",
    body: "Iran accuses US of 'cowardly war crime' as doctor says blast was 'so close' they thought the hospital was struck.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/16/iran-condemns-barbaric-us-attack-near-childrens-cancer-hospital?traffic_source=rss",
    time: "4 ore fa",
    pub_ts: 1784227075,
    tags: [],
  },
  {
    ...
    body: "Iranian media reports airport, bridge and communications tower targeted.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "Donald Trump has refused to rule out sending US troops into Iran as fighting resumes and US strikes continue.",
    body: "Donald Trump has refused to rule out sending US troops into Iran as fighting resumes and US strikes continue.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/video/newsfeed/2026/7/16/what-could-a-us-ground-invasion-of-iran-look-like?traffic_source=rss",
    time: "4 ore fa",
    pub_ts: 1784227530,
    tags: [],
  },
  ...
  },
  {
    ...
    summary: "An Austin-based technology startup whose maritime drones were used by the US military in combat for the first time this week plans to build a $3.2 billion shipyard in South Texas.",
    body: "An Austin-based technology startup whose maritime drones were used by the US military in combat for the first time this week plans to build a $3.2 billion shipyard in South Texas.",
    source: "Bloomberg Tech",
    url: "https://www.bloomberg.com/news/articles/2026-07-16/sea-drone-maker-saronic-to-build-new-shipyard-in-south-texas",
    time: "9 ore fa",
    pub_ts: 1784209098,
    tags: [],
  },
  {
    ...
    summary: "Digi Spain Telecom SA shares closed lower in their debut in Spain on Thursday, after a rare initial public offering in the country.",
    body: "Digi Spain Telecom SA shares closed lower in their debut in Spain on Thursday, after a rare initial public offering in the country.",
    source: "Bloomberg Tech",
