// Generato automaticamente il 2026-07-24 06:32 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784874735;
...
const NEWS = [
  ...
  },
  {
    id: 5,
    cat: "geopolitica",
    title: "La primera entrevista de Zapatero desde su imputación no despeja las incógnitas del caso: “Hay mucho que explicar de esas joyas todavía”",
    summary: "El ex presidente, imputado por el caso Plus Ultra, rompió su silencio en la televisión pública, pero no aportó pruebas ni datos adicionales",
    body: "El expresidente del Gobierno José Luis Rodríguez Zapatero acudió este jueves al programa Mañaneros , de RTVE, para explicar públicamente su versión del caso Plus Ultra. Era la primera entrevista que concedía a un medio desde que un juez de la Audiencia Nacional lo imputó en mayo por su presunta participación en una trama de tráfico de influencias y blanqueo de capitales en torno al rescate de la aerolínea Plus Ultra en 2021.\n\nSeguir leyendo",
    source: "El Pais",
    url: "https://elpais.com/podcasts/hoy-en-el-pais/2026-07-24/por-que-zapatero-ha-decidido-hablar.html",
    time: "2 ore fa",
    pub_ts: 1784864701,
    tags: [],
  },
