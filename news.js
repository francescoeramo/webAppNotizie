// Generato automaticamente il 2026-07-17 17:18 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784308666;
...
const NEWS = [
  {
    id: 1,
    cat: "politica-italiana",
    title: "Mario Roggero è arrivato nel carcere milanese di Bollate: \"Mattarella ha graziato Minetti, si metta una mano alla coscienza\". Nordio va avanti sulla grazia",
    summary: "Il ministro avvia l'istruttoria, attivati i magistrati. La moglie fa istanza per la grazia. Meloni contro i risarcimenti: \"Chi commette reati non può essere risarcito. Mi aggredisci, mi difendo. E dovrei risarcirti?\"",
    body: "Il ministro avvia l'istruttoria, attivati i magistrati. La moglie fa istanza per la grazia. Meloni contro i risarcimenti: \"Chi commette reati non può essere risarcito. Mi aggredisci, mi difendo. E dovrei risarcirti?\"",
    source: "ANSA",
  ...
  },
  {
    ...
    summary: "Twenty people also injured in strike on funeral procession for Palestinian killed by Israel earlier in the day.",
    body: "Twenty people also injured in strike on funeral procession for Palestinian killed by Israel earlier in the day.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "Russian attacks reportedly kill two Ukrainians aboard foreign vessel in Mykolaiv; two more killed in Kherson and Odesa.",
    body: "Russian attacks reportedly kill two Ukrainians aboard foreign vessel in Mykolaiv; two more killed in Kherson and Odesa.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Google is adding personalized AI avatars to Vids that let users create videos starring a digital version of themselves, alongside Gemini Omni-powered tools for generating and editing videos from prompts and reference images.",
    source: "TechCrunch",
