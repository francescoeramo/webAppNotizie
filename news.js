// Generato automaticamente il 2026-07-21 21:17 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784668649;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "A Russian guided aerial bomb attack on Zaporizhzhia, Ukraine, killed at least three people and injured 13 others.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "The order prevents thousands from El Salvador, Sudan and Ukraine from losing work authorisation while lawsuit proceeds.",
    body: "The order prevents thousands from El Salvador, Sudan and Ukraine from losing work authorisation while lawsuit proceeds.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/21/us-judge-blocks-trump-bid-to-strip-work-permits-from-immigrants?traffic_source=rss",
    time: "1 ora fa",
    pub_ts: 1784663056,
    tags: [],
  },
  {
    ...
    summary: "With every new round of attacks raising political cost of compromise, analysts warn the window for peace may be closing.",
    body: "With every new round of attacks raising political cost of compromise, analysts warn the window for peace may be closing.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/news/2026/7/21/can-mediators-broker-a-truce-between-the-us-and-iran?traffic_source=rss",
    time: "1 ora fa",
    pub_ts: 1784662046,
    tags: [],
  },
  ...
  },
  {
    id: 20,
    cat: "economia-tech",
    title: "Robinhood Prediction Market Revenue to Top Crypto, Analysts Say",
