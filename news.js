// Generato automaticamente il 2026-07-18 13:41 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784382045;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "Lo que en un principio tendría que corresponder a un asunto meramente privado se ha convertido en un escándalo público que podría costarle la carrera a uno de los hombres más poderosos de la política alemana, Jens Spahn , que hasta este sábado era presidente del grupo parlamentario conservador CDU/CSU en el Bundestag alemán. Spahn y su marido Daniel Funke anunciaron el miércoles pasado que se habían convertido en padres del bebé Georg.\n\nEn declaraciones al diario sensacionalista Bild , confirmaron que para ello habían recurrido a un vientre de alquiler en Estados Unidos. Seguir leyendo",
    source: "El Pais",
  ...
  },
  {
    ...
    summary: "The US has bombed bridges and energy infrastructure in the seventh straight night of attacks on Iran.",
    body: "The US has bombed bridges and energy infrastructure in the seventh straight night of attacks on Iran.",
    source: "Al Jazeera",
    url: "https://www.aljazeera.com/video/newsfeed/2026/7/18/a-seventh-night-of-us-strikes-cuts-water-to-villages-in-irans-south?traffic_source=rss",
    time: "8 ore fa",
    pub_ts: 1784350064,
    tags: [],
  },
