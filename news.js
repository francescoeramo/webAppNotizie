// Generato automaticamente il 2026-07-22 22:10 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784758212;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "Russian Foreign Minister Sergei Lavrov is due to meet US counterpart Marco Rubio, but progress towards peace unlikely.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    summary: "Washington says deal would pave the way for ‘decades-long, multibillion-dollar partnership’",
    body: "Washington says deal would pave the way for ‘decades-long, multibillion-dollar partnership’",
