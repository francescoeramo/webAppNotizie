// Generato automaticamente il 2026-07-20 22:06 UTC da scripts/fetch_news.py
// NON modificare manualmente: viene sovrascritto ogni ora dalla GitHub Action.
var NEWS_TIMESTAMP = 1784585156;
...
const NEWS = [
  ...
  },
  {
    ...
    body: "Ukraine strikes Russian oil sites after major missile attack, as President Zelenskyy faces crisis over sacked minister.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "US president insists Netanyahu will not be arrested, despite ICC warrant.",
    source: "Al Jazeera",
  ...
  },
  {
    ...
    body: "Gaza residents weigh in on election of new Hamas leader",
    source: "Al Jazeera",
  ...
  },
  {
    id: 21,
    cat: "economia-tech",
    title: "Donald Trump says US to hit Canada with 50% tariffs",
